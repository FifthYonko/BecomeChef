 ...
 */
final class Version20220404120843 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recette ADD date DATE DEFAULT NULL');
    }
