 ...
 */
final class Version20220406122937 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE code_postale code_postal INT DEFAULT NULL');
    }
